...
namespace ZaykaMvc.Controllers
{
	public class AdminController : Controller
	{
        ...
        {
            var dish = context.Dishes.Find(id); // Assuming _context is your DbContext
            if (dish != null)
            {
                dish.IsAvailable = !dish.IsAvailable; // Toggle the availability status
                context.SaveChanges();
            }
            return RedirectToAction("AllDish"); // Redirect back to the list view
        }
